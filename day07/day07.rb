class Hand
  ...
  def type
    ...
    return FIVE_OF_A_KIND if cards[0] == 5
    return FOUR_OF_A_KIND if cards[0] == 4
    return FULL_HOUSE if cards[0] == 3 and cards[1] == 2
    return THREE_OF_A_KIND if cards[0] == 3
    return TWO_PAIR if cards[0] == 2 and cards[1] == 2
    return ONE_PAIR if cards[0] == 2
    HIGH_CARD
  end
